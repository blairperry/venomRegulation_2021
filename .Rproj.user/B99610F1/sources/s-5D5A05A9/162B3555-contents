...
########
setwd("~/Dropbox/CastoeLabFolder/projects/CVV_Gene_Regulation/_VenomGeneRegulation/analyses/gene_expression/")


# Read in normalized counts
all.normcounts <- read_csv('./normalized_counts/CvvVenomReg_RepRNAseq_wNonVen_VSTNormCounts_08.02.21.csv')

# Read in priority venom gene list
vg.pri <- read_tsv('../../data/venom_annotations/___PriorityVenomGenes_Sept2020/PriorityVenomGeneList_withNVPs_02.25.21.txt',col_names = F) %>% 
  select(X6,X7)
