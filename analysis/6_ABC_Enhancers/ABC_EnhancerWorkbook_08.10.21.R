...
write_tsv(venom.predics.simple,'./analysis/6_ABC_Enhancers/ABC_output/_reformat/EnhancerPredictionsFull_VenomGenes_simple_newID_08.10.21.bed',col_names = F)

write_tsv(venom.predics.simple %>% filter(str_detect(newID3,'SVMP')),'./analysis/6_ABC_Enhancers/ABC_output/_reformat/SVMP_EnhancerPredictionsFull_VenomGenes_simple_newID_08.10.21.bed',col_names = F)
write_tsv(venom.predics.simple %>% filter(str_detect(newID3,'SVSP')),'./analysis/6_ABC_Enhancers/ABC_output/_reformat/SVSP_EnhancerPredictionsFull_VenomGenes_simple_newID_08.10.21.bed',col_names = F)
write_tsv(venom.predics.simple %>% filter(str_detect(newID3,'PLA2')),'./analysis/6_ABC_Enhancers/ABC_output/_reformat/PLA2_EnhancerPredictionsFull_VenomGenes_simple_newID_08.10.21.bed',col_names = F)
write_tsv(venom.predics.simple %>% filter(str_detect(newID3,'cvt')),'./analysis/6_ABC_Enhancers/ABC_output/_reformat/Other_EnhancerPredictionsFull_VenomGenes_simple_newID_08.10.21.bed',col_names = F)
...
write_tsv(nonVen.predicts.simple,'./analysis/6_ABC_Enhancers/ABC_output/_reformat/EnhancerPredictionsFull_NONvenomGenes_simple_noDups_08.10.21.bed',col_names = F)
...
write_tsv(fulldetail,'./analysis/6_ABC_Enhancers/ABC_output/_reformat/EnhancerPredictionsFull_wVPERIDs_08.10.21.tsv')
