                        ...
                        if tfbs[0] == seq_id:
                            ...
                            if old_len != new_len:
                                ...
                                for k,set in enumerate(intervals):
                                    ...
                                    set_start = min(set)
                                    set_stop = max(set)
                                    aligned_tfbs.append([seq_id, str(set_start), str(set_stop), set_id,strand,footprint1,footprint2,footprint3,tfbs[3]])
                            elif old_len == new_len:
                                aligned_tfbs.append([seq_id, str(new_start), str(new_stop), tf_id,strand,footprint1,footprint2,footprint3,tfbs[3]])
